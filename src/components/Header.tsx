  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled 
          ? (darkMode ? 'bg-background shadow-sm border-b border-border' : 'bg-white shadow-sm') 
          : 'header-dark'
      }`}
    >
                ...
                className={`text-xs tracking-wide transition-colors duration-300 ${
                  scrolled 
                    ? (location.pathname === link.href 
                        ...
                        : (darkMode ? 'text-muted-foreground hover:text-foreground' : 'text-gray-500 hover:text-gray-900'))
